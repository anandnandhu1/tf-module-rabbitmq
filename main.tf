    ...
    "Statement": [
      {
        ...
        "Resource": [
          "arn:aws:ssm:us-east-1:402826549768:parameter/${var.env}.${var.component}*"
        ]
      },
      {
        "Sid": "VisualEditor1",
...
# we moved from service to ec2 node for rabbitmq
...
resource "aws_route53_record" "rabbitmq" {
  ...
  name    = "rabbitmq-${var.env}.anandnandhu.online"
  type    = "A"
  ttl     = 30
